...
console.log(process.env.EMAIL)
    ...
    await page.type('input[placeholder="Your email"]', process.env.USER);
    ...
    await page.evaluate(() => {
        let btn = [...document.querySelectorAll('button')].find(el => el.textContent.trim() === 'Login');
        if (btn) {
            btn.click();
        } else {
    ...
    await page.waitForSelector('input[placeholder="Search legal documents with context of your problem, fetch statutes, case laws, regulations and more"]');
    await page.type('input[placeholder="Search legal documents with context of your problem, fetch statutes, case laws, regulations and more"]', 'legal fraud notice');
    ...
    await page.evaluate(() => {
        let btn = [...document.querySelectorAll('button')].find(el => el.textContent.trim() === 'View Graph');
        if (btn) {
            btn.click();
        } else {
